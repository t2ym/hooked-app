...
let targetURL = 'https://localhost:8080/'; // no nginx proxy instead of the above config
...
targetURL = (loadOnly ? process.argv[3] : process.argv[2]) || targetURL;
...
(async () => {
  ...
  */
  ...
  let cacheBundlePath = path.join(__dirname, '..', 'root', target);
